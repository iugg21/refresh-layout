 ...
 */
public class WaitComingAdapter extends BaseQuickAdapter<WaitMovieBean.DataBean.ComingBean, BaseViewHolder> {

    public WaitComingAdapter() {
        super(R.layout.recycle_item_home_head_wait_movie);
    }

    @Override
    protected void convert(BaseViewHolder holder, WaitMovieBean.DataBean.ComingBean item) {
